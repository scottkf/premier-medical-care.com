...
<xsl:template match="data">
	<img class="photo float-left" src="{$workspace}/images/milstein-family.jpg" />
	<h3>Education</h3><br />
	<p>
	...
	<p>
		He is Board-Certified in Family Practice and is licensed in Florida, New York, and New Jersey. Dr Milstein did a fellowship in critical care medicine and has sub-speciality interest in women’s health, cardiology, and sports medicine. He has been practicing medicine in Palm Beach County since 1993.
	</p>
	<h3>Interests</h3><br />
	<p>
